              ...
              <div class="card">
                ...
                >
                  <div class="d-flex justify-content-end text-center py-1">
                    <div>
                      <p class="mb-1 h5 text-dark">253</p>
                      <p class="small text-muted mb-0">Photos</p>
                    </div>
                    <div class="px-3">
                      <p class="mb-1 h5  text-dark">{credentials.followers.length}</p>
                      <p class="small text-muted mb-0">Followers</p>
                    </div>
                    <div>
                      <p class="mb-1 h5  text-dark"></p>
                ...
                <div class="card-body p-4 text-black">
                  <div class="mb-5">
                    <p class="lead fw-normal mb-1  text-dark">About</p>
                    <div class="p-4" style={{ backgroundColor: "#f8f9fa" }}>
                      <p class="font-italic mb-1  text-dark">Web Developer</p>
                      <p class="font-italic mb-1  text-dark">
                        Lives in New York
                      </p>
